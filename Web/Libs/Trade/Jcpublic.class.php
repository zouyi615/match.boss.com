			...
			foreach($matchdates as $key=>$date){
	            ...
	            foreach($dat as $da){
	            	...
	            	if($isshow || !$now){
					    ...
					    $ret['match'][$k]['data'][$id]['isshow'] = $isshow;
					    $ret['match'][$k]['data'][$id]['matchnum'] = $matchnum;
					    $ret['match'][$k]['data'][$id]['processname'] = $processname;
					    $ret['match'][$k]['data'][$id]['processdate'] = $processdate;
