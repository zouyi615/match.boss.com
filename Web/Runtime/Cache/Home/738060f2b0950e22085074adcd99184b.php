				...
				<tbody>
					<?php if($team && is_array($team)){ foreach($team as $k=>$m){ ?>
						<tr class="data" data-id="<?php echo $m['tid']; ?>" ismod="0">
							...
							<td class="oddsname <?php echo $m['tname'] != $m['qtname']?'red':'' ?>"><?php echo $m['qtname']; ?></td>
			...
			<div class="col-xs-4">
				...
				<table class="table table-bordered table-hover table-condensed">
					<thead>
						...
						<tr><th>队名ID</th><th>500队名</th><th>球探网队名</th></tr>
					</thead>
					...
					<tbody class="tbody">
						<tr>
							...
							<td><input type="text" class="form-control input-sm" name="qtname[]" value=""></td>
						</tr>
					</tbody>
					<tr>
